...
class Dec
{
    ...
    static $_super2dec_arr = array('k' => 0, 'b' => 1, 'n' => 2,
        'g' => 3, 'a' => 4, '4' => 5, '9' => 6, 'e' => 7,
        'c' => 8, 'p' => 9, '3' => 10,
        '5' => 11, 't' => 12, '8' => 13, 'w' => 14,
        'u' => 15, 'q' => 16, 'i' => 17, 'r' => 18,
    ...
    static $_dec2super_arr = array(0 => 'k', 1 => 'b', 2 => 'n',
        3 => 'g', 4 => 'a', 5 => '4', 6 => '9', 7 => 'e',
        8 => 'c', 9 => 'p', 10 => '3',
        11 => '5', 12 => 't', 13 => '8', 14 => 'w',
        15 => 'u', 16 => 'q', 17 => 'i', 18 => 'r',
     ...
     * @return int | false
     */
    public function _super2dec_base($number)
    {
     ...
     * @return string | false
     */
    public function _dec2super_base($number)
    {
     ...
     * @return int | false
     */
    public function get_dec($number)
    {
        $renum = 0;
     ...
     * @return string | false
     */
    public function get_super($number)
    {
        $renum = '';
        if (empty($number)) {
     ...
     * @return int | false
     */
    public function get_dec_s($number)
    {
        $dd = $number[0];
     ...
     * @return string | false
     */
    public function get_super_s($number)
    {
     ...
     * @return string
     */
    public function get_unique($ulen = 15, $germ = '')
    {
...
$t = time();
$s = Dec::get_super($t);
echo 'T1:'.Dec::get_dec($s).'--'.$s.'<hr/>';

//用加密的方式转换10进制数
$s = Dec::get_super_s($t);
echo 'T2:'.Dec::get_dec_s($s).'--'.$s.'<hr/>';

//获得一个唯一标识（长度12-16）
echo 'T3:'.Dec::get_unique(16).'<hr/>';
 */
