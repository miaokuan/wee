...
class HTML_To_Markdown
{
    ...
    private $options = array(
        'header_style' => 'atx', // Set to "atx" to output H1 and H2 headers as # Header1 and ## Header2  default:"setext"
        'suppress_errors' => true, // Set to false to show warnings when loading malformed HTML
        'strip_tags' => false, // Set to true to strip tags that don't have markdown equivalents. N.B. Strips tags, not their content. Useful to clean MS Word HTML output.
        'bold_style' => '', // Set to '__' if you prefer the underlined style default:'**'
        'italic_style' => '', // Set to '_' if you prefer the underlined style default:'*'
    );
